...
nwfsc_station<- as.numeric(unlist(nwfsc_stations$LATITUDE))
...
nwfsc_stations <- nwfsc_stations %>%
                    mutate(SCI_CENTER="NWFSC")


stations<- rbind(swfsc_stations, nwfsc_stations)
